...
plot(merge2$norm.fsc,merge2$pgC.cell, log='xy', yaxt='n',cex=2,bg='red3', pch=21, ylab=expression(paste("Qc (pgC cell"^{-1},")")), xlab="Normalized scatter (dimensionless)", main=paste0("SeaFlow #",inst))
